...
class _FakeCloudinaryService extends CloudinaryService {
  _FakeCloudinaryService(this._words, {this.shouldThrow = false}) : super();
...
void main() {
  ...
  test(
    'enriches fallback words with web images and stores them in cache',
    () async {
      final prefs = await SharedPreferences.getInstance();
      ...
      expect(
        webProvider.requestedKeys,
        equals(<String>['ripe red apple fruit', 'yellow banana fruit bunch']),
      );
